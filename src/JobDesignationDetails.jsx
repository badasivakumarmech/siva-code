...
function JobDesignationDetails() {
  const elementRefs = {};
  ...
  const allButtons = [
    ...
    'Abstractor','AcadamicAssociate', 'Consultant', 'Coordinator', 'Counsellor',
    ...
    'Secretary', 'Corparate', 'SiteEngg', 'Film', 'Teacher', 'Airline', 'GraphicDesigner',
    'Shipping', 'Analytics'
  ];
  const handleSearch = () => {
...
export default JobDesignationDetails;
